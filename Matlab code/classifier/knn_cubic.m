function [trainedClassifier, validationAccuracy] = knn_cubic(trainingData, responseData)
...
inputTable = array2table(trainingData);
predictorNames = inputTable.Properties.VariableNames;predictors = inputTable(:, predictorNames);
response = responseData;
isCategoricalPredictor = false(1, length(trainingData(1,:)));
