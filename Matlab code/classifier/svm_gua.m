function [trainedClassifier, validationAccuracy] = svm_gua(trainingData, responseData)
...
isCategoricalPredictor = repmat(false, 1, length(trainingData(1,:)));
...
template = templateSVM(...
    ...
    'PolynomialOrder', [], ...
    'KernelScale', 220.1339811592306, ...
    'BoxConstraint', 694.0272909287934, ...
    'Standardize', true);
